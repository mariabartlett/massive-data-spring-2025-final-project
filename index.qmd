...
# Load data
gender_data = read.csv('data/all_sports_data.csv')
...
inst_level_numerical_no_coed_no_na_no_name = read.csv('data/inst_level_pca_data.csv')
...
#| warning: false
#| message: false
basketball_data = read.csv('data/basketball_sport_data.csv')
...
=======
>>>>>>> 2635112 (Added data pipeline section)
```{r}
#| eval: true
#| echo: false
#| warning: false
#| message: false
xc_tf_data = read.csv('data/xctf_sport_data.csv')
