...
The `Schools.csv` file contains variables such as participation numbers, expenses, and recruitment budgets across various sports programs. The `InstLevel.csv` file includes institution-wide aggregates such as salary information of head and assistant coaches and athletes’ financial aid information. 
